...
#include "module-telnet_interface\telnet_if.h"
...
/// Holds the TeamSpeak Client Functions
...
void ts3plugin_setFunctionPointers(const struct TS3Functions funcs) {
    ...
    //Telnet_interface::set_ts3_functions(&ts3Functions);
}
...
void ts3plugin_shutdown() {
	...
	ts3Functions.logMessage("Shutdown", LogLevel_DEBUG, "", 0);
...
int ts3plugin_onClientPokeEvent(uint64 serverConnectionHandlerID, anyID fromClientID, const char* pokerName, const char* pokerUniqueIdentity, const char* message, int ffIgnored) {
    ...
    Telnet_interface::get_instance()->handle_poke(serverConnectionHandlerID, fromClientID, pokerName, message);
